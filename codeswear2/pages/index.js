...
export default function Home() {
  return (
   ...
   <div>
    <img className=' p-10 w-[100rem] h-[30rem]' src="/image3.jpg" alt="" />
    <div>
    <section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Codeswear - Get Ready to Wear the Code</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Coding is not a task it is a passion , you should have to follow your passion. Codeswear help you to provide your passion with your fashion</p>
    </div>
